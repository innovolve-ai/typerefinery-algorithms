...
def main():
    ...
    with open('input_test2_colaGraph_sample.json') as json_file:
        data = json.load(json_file)
    
    # load in json colagraph test_definition
    with open('input_test2_definition.json') as json_file:
    ...
    with open("test2_output_Grouped.json", "w") as outfile:  
